    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'We have send reset password link to your email!');
            window.setTimeout(function () {
...
var resetpassword = exports.resetpassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, passwordConfirm, resetToken) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Create user successfully!");
            window.setTimeout(function () {
...
var updateUser = exports.updateUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data, id, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          url = type === 'password' ? "/api/v1/users/".concat(id, "/updatepassword") : "/api/v1/users/".concat(id);
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
  ...
  return function updateUser(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Delete user successfully!");
            window.setTimeout(function () {
              location.reload();
            }, 500);
          }
...
var createReview = exports.createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, data) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Post your review successfully!");
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Delete review successfully!");
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
...
var updateReview = exports.updateReview = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Update review successfully!");
            window.setTimeout(function () {
  ...
  return function updateReview(_x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Delete booking successfully!");
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
...
var stripe = Stripe('pk_test_51ODcUPEJYMV0dwY5NBx9ySEcqL2MIH5NfBdw766sYs1ExEZJ54i4lUFZTSsPrq300Ui3VBblenWgHdD7clqbHRkw00Yb1rUTyg');
...
var forgotPasswordForm = document.querySelector('.form--forget-password');
var resetPasswordForm = document.querySelector('.form--reset-password');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var submitReviewBtn = document.getElementById('btn-submit-review');
var updateReviewBtn = document.getElementById('btn-submit-edit-review');
var userDataAddFormInAdmin = document.querySelector('.form-user-add-data');
var userDataFormInAdmin = document.querySelector('.form-user-data-admin');
var userPasswordFormInAdmin = document.querySelector('.form-user-password-admin');
var btnDeleteModel = document.querySelectorAll('.btn-confirm-delete');
var btnPagination = document.getElementById('btn-pagination');
...
if (forgotPasswordForm) forgotPasswordForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  (0, _resetpassword.forgetpassword)(email);
});
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          tourId = submitReviewBtn.getAttribute('tour-id');
          (0, _review.createReview)(tourId, {
            rating: rating,
            review: review
          });
        case 5:
...
if (updateReviewBtn) updateReviewBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var rating, review, reviewId;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          e.preventDefault();
          rating = document.querySelector('input[name="rating"]:checked').value;
          review = document.getElementById('reviewInput').value;
          reviewId = updateReviewBtn.getAttribute('review-id');
          (0, _review.updateReview)(reviewId, {
            rating: rating,
            review: review
          });
        case 5:
...
////////// ADMIN
if (btnDeleteModel) {
  btnDeleteModel.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var id = btn.getAttribute('data-id');
      console.log(id);
      var objecType = btn.getAttribute('object-type');
      if (objecType === 'user') {
        (0, _user.deleteUser)(id);
      } else if (objecType === 'review') {
        (0, _review.deleteReview)(id);
      } else if (objecType === 'booking') {
        (0, _booking.deleteBooking)(id);
      }
    });
  });
}
;
if (userDataAddFormInAdmin) userDataAddFormInAdmin.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
...
if (userDataFormInAdmin) userDataFormInAdmin.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  ...
  (0, _user.updateUser)(form, userId, 'data');
  // const name = document.getElementById('name').value;
  // const email = document.getElementById('email').value;
  // updateSettings({ name, email }, 'data');
});

if (userPasswordFormInAdmin) userPasswordFormInAdmin.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var password, passwordConfirm, userId;
