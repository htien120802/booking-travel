...
var btnDeleteModel = document.querySelector('.btn-confirm-delete');
...
////////// ADMIN
if (btnDeleteModel) btnDeleteModel.addEventListener('click', function (e) {
  var id = btnDeleteModel.getAttribute('data-id');
  console.log(id);
  var objecType = btnDeleteModel.getAttribute('object-type');
  if (objecType === 'user') {
